...
class AdminCommissionController extends Controller
{
    ...
    public function download(Request $request)
    {
        ...
        if ($request->has('date_range')) {
            ...
            switch ($dateRange) {
                case 'today':
                    $wallet->whereIn('doctors_id', $select_doctor)->whereDate('created_at', Carbon::today());
                    $period = Carbon::today()->format('j F Y');
                    break;
                case 'yesterday':
                    $wallet->whereIn('doctors_id', $select_doctor)->whereDate('created_at', Carbon::yesterday());
                    $period = Carbon::yesterday()->format('j F Y');
                    break;
                case 'this_week':
                    $startOfWeek = Carbon::now()->startOfWeek();
                    $endOfWeek = Carbon::now()->endOfWeek();
                    $wallet->whereIn('doctors_id', $select_doctor)->whereDate('created_at', '>=', $startOfWeek)->whereDate('created_at', '<=', $endOfWeek);
                ...
                case 'this_month':
                    $startOfMonth = Carbon::now()->startOfMonth();
                    $endOfMonth = Carbon::now()->endOfMonth();
                    $wallet->whereIn('doctors_id', $select_doctor)->whereDate('created_at', '>=', $startOfMonth)->whereDate('created_at', '<=', $endOfMonth);
                ...
                case 'custom_month':
                    $startMonth = $request->start_date;
                    $endMonth = $request->end_date;
                    $wallet->whereIn('doctors_id', $select_doctor)->whereDate('created_at', '>=', $startMonth)->whereDate('created_at', '<=', $endMonth);
                    ...
                    break;
                case 'custom_year':
                    $wallet->whereIn('doctors_id', $select_doctor)->where('f_year', $request->select_year);
