                    ...
                    <div class="box-body">
                        ...
                        <form class="form-horizontal" name=editprofile method="POST" action="{{ route('profile.update') }}">
                            ...
                            <div class="form-group{{ $errors->has('current_password') ? ' has-error' : '' }} row">
                                <label for="current_password" class="col-md-4 control-label">Current Password <span class="text-danger">*</span></label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group{{ $errors->has('new_password') ? ' has-error' : '' }} row">
                                <label for="new_password" class="col-md-4 control-label">New Password <span class="text-danger">*</span></label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="new_password-confirm" class="col-md-4 control-label">Confirm New Password <span class="text-danger">*</span></label>
                                <div class="col-sm-8">
