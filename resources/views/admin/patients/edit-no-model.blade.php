         ...
         <table id="example1" cellpadding="1" class="table table-bordered table-striped">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     <button id="editor_button_{{$emp->id}}" onclick="toggleEditor(this.id)">Editor</button>
                  </td>
                  <td>
               ...
               <tr id="show_editor_{{$emp->id}}" style="display:none;">
                  <td colspan="6">
...
<script>
   // Function to toggle the visibility of the editor when the button is clicked
   function toggleEditor(buttonId) {
      // Extract the ID number from the button ID
      var editorId = buttonId.split('_')[2];
      // Get the editor container element
      var editorContainer = document.getElementById('show_editor_' + editorId);
      // Toggle the visibility of the editor container
      if (editorContainer.style.display === 'none') {
         editorContainer.style.display = 'table-row';
         // Check if CKEditor instance already exists for the corresponding editor div
         var editorInstance = CKEDITOR.instances['editorContainer_' + editorId];
         if (!editorInstance) {
            // Create CKEditor instance for the corresponding editor div
