...
<div class="container">
  <center>
    <p style="font-size:16px;margin-top:-12px"><b>Pramukh Sonography Color Doppler and Digital X-Ray Center</b><br /><u>Financial Year Investigation Report</u></p>
  </center>
  <br />
  ...
  <table>
    ...
    $USG_a = 0;
    $discount = 0;
    $formattedDate = Carbon::createFromFormat('F Y', $key);
