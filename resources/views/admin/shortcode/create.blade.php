...
<div class="content-wrapper">
   ...
   <section class="content-header" style="display: flex; align-items: center;">
      ...
      <ol class=" breadcrumb" style="margin-left: auto; display: flex; align-items: center;">
         ...
         <li class="active">Add Short Code</li>
      </ol>
   </section>
   <!-- Main content -->
      ...
      <div class="row">
         ...
         <div class="col-12">
            ...
            <div class="box box-info">
               ...
               {!! Form::open(['method'=>'POST', 'action'=> 'AdminShortCodeController@store','files'=>true,'class'=>'form-horizontal', 'name'=>'addshortform']) !!}
               @csrf
               <div class="box-body">
...
<script>
   $(function() {
      $("form[name='addshortform']").validate({
         rules: {
            code: {
               required: true,
            },
