...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         <b>Report Types</b> <a href="{{route('admin.report_types.create')}}" class="bg-primary text-white text-decoration-none" style="padding:8px 12px;margin-left:15px"><i class="fa fa-plus" style="font-size:15px;">&nbsp;ADD</i></a>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
         <div class="col-xs-12">
            <div class="box">
               ...
               <!-- <div class="row">
                  <div class="col-md-9">
                     <a href="{{route('admin.report_types.create')}}" class="bg-primary text-white text-decoration-none" style="padding:12px 12px;margin-left:20px"><i class="fa fa-plus editable" style="font-size:15px;">&nbsp;ADD</i></a>
                  </div>
               </div> -->
               <!-- /.box-header -->
